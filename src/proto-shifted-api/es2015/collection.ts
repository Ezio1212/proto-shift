...
} = /*@__PURE__*/ unbind(Map.prototype.clear) as any;
...
} = /*@__PURE__*/ unbind(Map.prototype.delete) as any;
...
} = /*@__PURE__*/ unbind(Map.prototype.forEach) as any;
...
} = /*@__PURE__*/ unbind(Map.prototype.get) as any;
...
export const mapHas: {
  <K, V>(_this: Map<K, V>, key: K): boolean;
} = /*@__PURE__*/ unbind(Map.prototype.has) as any;
...
} = /*@__PURE__*/ unbind(Map.prototype.set) as any;
...
} = /*@__PURE__*/ unbind(WeakMap.prototype.delete) as any;
/**
 * @returns a specified element.
 */
export const weakMapGet: {
  <K extends object, V>(_this: WeakMap<K, V>, key: K): V | undefined;
} = /*@__PURE__*/ unbind(WeakMap.prototype.get) as any;
/**
 * @returns a boolean indicating whether an element with the specified key exists or not.
 */
export const weakMapHas: {
  <K extends object, V>(_this: WeakMap<K, V>, key: K): boolean;
} = /*@__PURE__*/ unbind(WeakMap.prototype.has) as any;
/**
...
} = /*@__PURE__*/ unbind(WeakMap.prototype.set) as any;
...
} = /*@__PURE__*/ unbind(Set.prototype.add) as any;

export const setClear: {
  <T>(_this: Set<T>): void;
} = /*@__PURE__*/ unbind(Set.prototype.clear) as any;
/**
...
} = /*@__PURE__*/ unbind(Set.prototype.delete) as any;
/**
...
} = /*@__PURE__*/ unbind(Set.prototype.forEach) as any;
/**
 * @returns a boolean indicating whether an element with the specified value exists in the Set or not.
 */
export const setHas: {
  <T>(_this: Set<T>, value: T): boolean;
} = /*@__PURE__*/ unbind(Set.prototype.has) as any;
